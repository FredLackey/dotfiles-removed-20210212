...
execute "defaults write com.apple.menuextra.clock DateFormat 'EEE MMM d  HHmm'" \
...
#
# https://github.com/FredLackey/dotfiles/commit/035dda057ddc6013ba21db3d2c30eeb51ba8f200
